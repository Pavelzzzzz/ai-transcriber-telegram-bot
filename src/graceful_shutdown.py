...
class GracefulShutdownManager:
    ...
    def request_shutdown(self, signal_number: int | None = None, frame: Any | None = None) -> None:
...
def request_shutdown(signal_number: int | None = None, frame: Any | None = None) -> None:
