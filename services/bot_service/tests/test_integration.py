...
class TestKafkaProducerConsumer:
    ...
    @pytest.mark.integration
    @pytest.mark.skipif(os.getenv("KAFKA_BOOTSTRAP_SERVERS") is None, reason="Kafka not available")
...
class TestBotServiceHandlers:
    ...
    def test_pending_tasks_storage(self):
        ...
        pending_tasks[task_id] = {"chat_id": 12345, "task_type": "ocr", "file_path": "/test.jpg"}
